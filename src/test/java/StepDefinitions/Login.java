...
//        boolean userloggedIn = webDriver.findElement(By.xpath("//a[contains(text().'welcome'0]")).isDisplayed();
        boolean userloggedIn = driver.findElement(By.xpath("//*[@id='welcome']")).isDisplayed();
        if (userloggedIn) {
